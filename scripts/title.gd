...
func _draw() -> void:
	...
	if Data.dev:
		_frame(Rect2(576, 8, 132, 38), Color("c0392b"), Color("3a0e0a"), Color(1, 0.7, 0.6, 0.35), Color(0, 0, 0, 0.2), 6.0)
		draw_string(font, Vector2(576, 35), "DEV BUILD", HORIZONTAL_ALIGNMENT_CENTER, 132, 19, Color.WHITE)
